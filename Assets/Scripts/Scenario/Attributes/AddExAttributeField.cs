...
#if UNITY_EDITOR
namespace AddExAttribute.Internal
{
...
public class EnumFlagsAttribute : PropertyAttribute
{
    ...
    public EnumFlagsAttribute(System.Type inType)
    {
        propType = inType;
    }
}
...
public class EnumFlagsAttributeDrawer : PropertyDrawer
{
    public override void OnGUI(Rect _position, SerializedProperty _property, GUIContent _label)
    {
        ...
        System.Enum enumValue = System.Enum.ToObject(attr.propType, _property.intValue) as System.Enum;

        var retValue = EditorGUI.EnumMaskField(_position, _label, enumValue);
        _property.intValue = System.Convert.ToInt32(retValue);
    }
}
#endif